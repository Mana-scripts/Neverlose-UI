...
function Mainholder:decode(data)
 ...
 function Mainholder:Window(hubname, gamename, _Intro)
   ...
   if _Intro then
      ...
      local LoadFrameIndicator = Instance.new("Frame")
      local LoadFrameIndicatorCorner = Instance.new("UICorner")
      local ModulesLoaded = Instance.new("TextLabel")
      ...
      MainFrame.Position = UDim2.new(0.388535023, 0, 0.376237631, 0)
      MainFrame.Size = UDim2.new(0.222292989, 0, 0.247524753, 0)
      ...
      Credits.Position = UDim2.new(0, 0, 0.829999983, 0)
      Credits.Size = UDim2.new(1, 0, 0.0949999988, 0)
      Credits.Font = MainFont
      Credits.Text = "Made by Mana"
      ...
      LoadFrame.Position = UDim2.new(0.0401146114, 0, 0.49000001, 0)
      LoadFrame.Size = UDim2.new(0.919770777, 0, 0.0199999996, 0)

      LoadFrameCorner.CornerRadius = UDim.new(0, 5)
      LoadFrameCorner.Name = "LoadFrameCorner"
      LoadFrameCorner.Parent = LoadFrame

      LoadFrameIndicator.Name = "LoadFrameIndicator"
      LoadFrameIndicator.Parent = LoadFrame
      LoadFrameIndicator.BackgroundColor3 = Color3.fromRGB(255, 123, 29)
      LoadFrameIndicator.BorderColor3 = Color3.fromRGB(0, 0, 0)
      LoadFrameIndicator.BorderSizePixel = 0
      LoadFrameIndicator.Size = UDim2.new(0.401869148, 0, 1, 0)

      LoadFrameIndicatorCorner.CornerRadius = UDim.new(0, 5)
      LoadFrameIndicatorCorner.Name = "LoadFrameIndicatorCorner"
      LoadFrameIndicatorCorner.Parent = LoadFrameIndicator

      ModulesLoaded.Name = "ModulesLoaded"
      ModulesLoaded.Parent = MainFrame
      ModulesLoaded.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
      ModulesLoaded.BackgroundTransparency = 1.000
      ModulesLoaded.BorderColor3 = Color3.fromRGB(0, 0, 0)
      ModulesLoaded.BorderSizePixel = 0
      ModulesLoaded.Position = UDim2.new(0, 0, 0.540000021, 0)
      ModulesLoaded.Size = UDim2.new(1, 0, 0.0799999982, 0)
      ModulesLoaded.Font = MainFont
      ModulesLoaded.Text = ""
      ModulesLoaded.TextColor3 = Color3.fromRGB(255, 123, 29)
      ModulesLoaded.TextScaled = true
      ModulesLoaded.TextSize = 14.000
      ModulesLoaded.TextWrapped = true
      ModulesLoaded.Visible = false

      local TweenService = game:GetService("TweenService")
      local Modules = math.random(30, 50)

      function Welcome()
         MainFrame.Size = UDim2.new(0, 0, 0.247524753, 0)
         MainFrame.Visible = false
         ...
         TweenService:Create(
            ...
            {Size = UDim2.new(0.222292989, 0, 0.247524753, 0)}
         ):Play()

         repeat task.wait() until MainFrame.Size == UDim2.new(0.222292989, 0, 0.247524753, 0)
      ...
      function Outro()
         ...
         TweenService:Create(
            MainFrame,
            TweenInfo.new(0.6, Enum.EasingStyle.Quad),
            {Size = UDim2.new(0, 0, 0.247524753, 0)}
         ):Play()

         repeat task.wait() until MainFrame.Size == UDim2.new(0, 0, 0.247524753, 0)
         task.wait(0.1)
         Intro:Destroy()
      ...
      function loadmodules()
         ModulesLoaded.Text = "0/"..Modules
         repeat task.wait() until MainFrame.Size == UDim2.new(0.222292989, 0, 0.247524753, 0)
         task.wait(2)
         for i = 1, Modules do
            ModulesLoaded.Text = i.."/"..Modules
            task.wait(math.random(1,2)*0.04)
         end
         ModulesLoaded.Visible = false
      end

      function loadline()
         LoadFrameIndicator.Size = UDim2.new(0, 0, 1, 0)
         repeat task.wait() until MainFrame.Size == UDim2.new(0.222292989, 0, 0.247524753, 0)
         task.wait(2)
         TweenService:Create(
            LoadFrameIndicator,
         ...
         repeat task.wait() until ModulesLoaded.Text == Modules.."/"..Modules
         TweenService:Create(
            LoadFrameIndicator,
            TweenInfo.new(0.3, Enum.EasingStyle.Quad),
      ...
      spawn(function()
         repeat task.wait() until LoadFrameIndicator.Size == UDim2.new(1,0,1,0)
         Outro()
      end)
